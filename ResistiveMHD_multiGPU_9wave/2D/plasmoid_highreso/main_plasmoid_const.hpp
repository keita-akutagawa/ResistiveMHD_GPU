...
std::string directoryname = "/cfca-work/akutagawakt/ResistiveMHD_9wave/results_plasmoid";
std::string filenameWithoutStep = "plasmoid";
std::ofstream logfile("/cfca-work/akutagawakt/ResistiveMHD_9wave/results_plasmoid/log_plasmoid.txt");
