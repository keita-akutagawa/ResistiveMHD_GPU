...
struct LeftParameterFunctor {
    ...
    BasicParameter operator()(const thrust::tuple<BasicParameter, BasicParameter, BasicParameter>& tupleForLeft) const {
        ...
        dQLeft.rho = dQ.rho + 0.5f * minmod(dQ.rho - dQMinus1.rho, dQPlus1.rho - dQ.rho);
        dQLeft.u   = dQ.u   + 0.5f * minmod(dQ.u   - dQMinus1.u  , dQPlus1.u   - dQ.u  );
        dQLeft.v   = dQ.v   + 0.5f * minmod(dQ.v   - dQMinus1.v  , dQPlus1.v   - dQ.v  );
        dQLeft.w   = dQ.w   + 0.5f * minmod(dQ.w   - dQMinus1.w  , dQPlus1.w   - dQ.w  );
        dQLeft.bY  = dQ.bY  + 0.5f * minmod(dQ.bY  - dQMinus1.bY , dQPlus1.bY  - dQ.bY );
        dQLeft.bZ  = dQ.bZ  + 0.5f * minmod(dQ.bZ  - dQMinus1.bZ , dQPlus1.bZ  - dQ.bZ );
        dQLeft.p   = dQ.p   + 0.5f * minmod(dQ.p   - dQMinus1.p  , dQPlus1.p   - dQ.p  );
...
struct RightParameterFunctor {
    ...
    BasicParameter operator()(const thrust::tuple<BasicParameter, BasicParameter, BasicParameter>& tupleForRight) const {
        ...
        dQRight.rho = dQPlus1.rho - 0.5f * minmod(dQPlus1.rho - dQ.rho, dQPlus2.rho - dQPlus1.rho);
        dQRight.u   = dQPlus1.u   - 0.5f * minmod(dQPlus1.u   - dQ.u  , dQPlus2.u   - dQPlus1.u  );
        dQRight.v   = dQPlus1.v   - 0.5f * minmod(dQPlus1.v   - dQ.v  , dQPlus2.v   - dQPlus1.v  );
        dQRight.w   = dQPlus1.w   - 0.5f * minmod(dQPlus1.w   - dQ.w  , dQPlus2.w   - dQPlus1.w  );
        dQRight.bY  = dQPlus1.bY  - 0.5f * minmod(dQPlus1.bY  - dQ.bY , dQPlus2.bY  - dQPlus1.bY );
        dQRight.bZ  = dQPlus1.bZ  - 0.5f * minmod(dQPlus1.bZ  - dQ.bZ , dQPlus2.bZ  - dQPlus1.bZ );
        dQRight.p   = dQPlus1.p   - 0.5f * minmod(dQPlus1.p   - dQ.p  , dQPlus2.p   - dQPlus1.p  );
...
{
    //thrust::tuple<thrust::device_vector<float>::iterator, thrust::device_vector<float>::iterator, thrust::device_vector<float>::iterator>
