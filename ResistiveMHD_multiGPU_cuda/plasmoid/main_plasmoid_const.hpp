...
std::string directoryname = "/cfca-work/akutagawakt/ResistiveMHD_cuda/results_plasmoid_procs=1";
std::string filenameWithoutStep = "plasmoid";
std::ofstream logfile("/cfca-work/akutagawakt/ResistiveMHD_cuda/results_plasmoid_procs=1/log_plasmoid.txt");
...
const double betaUpstream = 0.5 * 0.5;
...
const double dx = sheatThickness / 16.0;
const int nx = int((xmax - xmin) / dx);
const double ymin = 0.0;
const double ymax = 50.0;
const double dy = sheatThickness / 16.0;
